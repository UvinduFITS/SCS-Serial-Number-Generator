...
<head>
  ...
  <title>Welcome to SCS Operations</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.06);">
          ...
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(135deg,#2563eb 0%,#1e40af 100%);padding:36px 30px;text-align:center;">
              <div style="display:inline-block;width:56px;height:56px;background:#ffffff;border-radius:12px;line-height:56px;font-size:20px;font-weight:800;color:#2563eb;margin-bottom:14px;">
                SCS
              </div>
              <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:0.2px;">
                Welcome to SCS Operations
              </h1>
              <p style="margin:6px 0 0;color:#dbeafe;font-size:13px;">
                Serial Number Generator System
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 36px 16px;">
              ...
              <p style="margin:0 0 18px;color:#4b5563;font-size:14px;line-height:1.6;">
                An administrator has created an account for you on the SCS Operations Serial Number Generator System. Below are your login details — please keep them confidential.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:8px 36px 28px;">
              <a href="${escapeHtml(opts.login_url)}" target="_blank"
                 style="display:inline-block;padding:14px 36px;background:#2563eb;color:#ffffff;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;box-shadow:0 4px 12px rgba(37,99,235,0.3);">
                Go to System →
              </a>
            </td>
          </tr>
            ...
            <td style="padding:0 36px 28px;">
              <div style="background:#fef3c7;border-left:3px solid #f59e0b;padding:12px 16px;border-radius:6px;">
                <p style="margin:0;color:#92400e;font-size:12px;line-height:1.5;">
                  <strong>Security tip:</strong> For your safety, please change your password immediately after your first login.
                </p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#f9fafb;padding:20px 30px;text-align:center;border-top:1px solid #e5e7eb;">
              <p style="margin:0;color:#9ca3af;font-size:11px;line-height:1.5;">
                SCS Operations Internal System — Authorized Users Only<br>
